...
void surfacemesh_decorate_normals::decorate(SurfaceMeshModel* mesh, StarlabDrawArea* /*parent*/, QPainter* /*p*/){
    float NormalLen =.05; /// @todo read from setting
    float LineLen = mesh->getBoundingBox().size().length() * NormalLen;    
